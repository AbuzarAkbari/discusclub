...
-- Mon 20 Nov 2017 02:44:06 PM CET
...
-- -----------------------------------------------------
-- Table `forum`.`aquarium`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`aquarium` ;

CREATE TABLE IF NOT EXISTS `forum`.`aquarium` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(100) NOT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted_at` TIMESTAMP NULL,
...
CREATE TABLE IF NOT EXISTS `forum`.`image` (
  ...
  INDEX `fk_image_aquarium1_idx` (`aquarium_id` ASC),
  CONSTRAINT `fk_image_album1`
    FOREIGN KEY (`album_id`)
    REFERENCES `forum`.`album` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_image_aquarium1`
    FOREIGN KEY (`aquarium_id`)
    REFERENCES `forum`.`aquarium` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `forum`.`aquarium_reply`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`aquarium_reply` ;

CREATE TABLE IF NOT EXISTS `forum`.`aquarium_reply` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `content` TEXT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_aquarium_reply_user1_idx` (`user_id` ASC),
  INDEX `fk_aquarium_reply_aquarium1_idx` (`aquarium_id` ASC),
  CONSTRAINT `fk_aquarium_reply_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `forum`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_aquarium_reply_aquarium1`
    FOREIGN KEY (`aquarium_id`)
    REFERENCES `forum`.`aquarium` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `forum`.`contest`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`contest` ;

CREATE TABLE IF NOT EXISTS `forum`.`contest` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `forum`.`like`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`like` ;
...
CREATE TABLE IF NOT EXISTS `forum`.`like` (
  ...
  INDEX `fk_aquarium_has_user_user1_idx` (`user_id` ASC),
  INDEX `fk_aquarium_has_user_aquarium1_idx` (`aquarium_id` ASC),
  PRIMARY KEY (`id`),
  INDEX `fk_like_contest1_idx` (`contest_id` ASC),
  CONSTRAINT `fk_aquarium_has_user_aquarium1`
    FOREIGN KEY (`aquarium_id`)
    REFERENCES `forum`.`aquarium` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_aquarium_has_user_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `forum`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_like_contest1`
    FOREIGN KEY (`contest_id`)
    REFERENCES `forum`.`contest` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `forum`.`page`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`page` ;

CREATE TABLE IF NOT EXISTS `forum`.`page` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_page_image1_idx` (`image_id` ASC),
  CONSTRAINT `fk_page_image1`
    FOREIGN KEY (`image_id`)
    REFERENCES `forum`.`image` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `forum`.`category_permission`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`category_permission` ;

CREATE TABLE IF NOT EXISTS `forum`.`category_permission` (
  `category_id` INT NOT NULL,
  `role_id` INT NOT NULL,
  PRIMARY KEY (`category_id`, `role_id`),
  INDEX `fk_category_has_role_role1_idx` (`role_id` ASC),
  INDEX `fk_category_has_role_category1_idx` (`category_id` ASC),
  CONSTRAINT `fk_category_has_role_category1`
    FOREIGN KEY (`category_id`)
    REFERENCES `forum`.`category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_category_has_role_role1`
    FOREIGN KEY (`role_id`)
    REFERENCES `forum`.`role` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `forum`.`sub_category_permission`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`sub_category_permission` ;

CREATE TABLE IF NOT EXISTS `forum`.`sub_category_permission` (
  `sub_category_id` INT NOT NULL,
  `role_id` INT NOT NULL,
  PRIMARY KEY (`sub_category_id`, `role_id`),
  INDEX `fk_sub_category_has_role_role1_idx` (`role_id` ASC),
  INDEX `fk_sub_category_has_role_sub_category1_idx` (`sub_category_id` ASC),
  CONSTRAINT `fk_sub_category_has_role_sub_category1`
    FOREIGN KEY (`sub_category_id`)
    REFERENCES `forum`.`sub_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sub_category_has_role_role1`
    FOREIGN KEY (`role_id`)
    REFERENCES `forum`.`role` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `forum`.`news_permission`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`news_permission` ;

CREATE TABLE IF NOT EXISTS `forum`.`news_permission` (
  `news_id` INT NOT NULL,
  `role_id` INT NOT NULL,
  PRIMARY KEY (`news_id`, `role_id`),
  INDEX `fk_news_has_role_role1_idx` (`role_id` ASC),
  INDEX `fk_news_has_role_news1_idx` (`news_id` ASC),
  CONSTRAINT `fk_news_has_role_news1`
    FOREIGN KEY (`news_id`)
    REFERENCES `forum`.`news` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_news_has_role_role1`
    FOREIGN KEY (`role_id`)
    REFERENCES `forum`.`role` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `forum`.`topic_permission`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `forum`.`topic_permission` ;

CREATE TABLE IF NOT EXISTS `forum`.`topic_permission` (
  `topic_id` INT NOT NULL,
  `role_id` INT NOT NULL,
  PRIMARY KEY (`topic_id`, `role_id`),
  INDEX `fk_topic_has_role_role1_idx` (`role_id` ASC),
  INDEX `fk_topic_has_role_topic1_idx` (`topic_id` ASC),
  CONSTRAINT `fk_topic_has_role_topic1`
    FOREIGN KEY (`topic_id`)
    REFERENCES `forum`.`topic` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_topic_has_role_role1`
    FOREIGN KEY (`role_id`)
    REFERENCES `forum`.`role` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
