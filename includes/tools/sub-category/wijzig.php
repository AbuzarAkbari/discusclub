...
$sql = 'SELECT *, sub_category.name, role.name AS role_name FROM sub_category LEFT JOIN sub_category_permission AS scp ON scp.category_id = sub_category.id LEFT JOIN role ON role.id = scp.role_id WHERE sub_category.id = :id';
