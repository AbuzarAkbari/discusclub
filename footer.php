        ...
        <div class='container-fluid text-center'>
            <div class='row'>
                ...
                <div class='col-md-4'>
                    ...
                    <a href='https://twitter.com/DiscusHolland?ref_src=twsrc%5Etfw' class='twitter-follow-button' data-show-count='false'>Follow @DiscusHolland</a>
                    <script async src='//platform.twitter.com/widgets.js' charset='utf-8'></script><br>
                    <a class='twitter-timeline col-md-3' href='https://twitter.com/DiscusHolland?ref_src=twsrc%5Etfw' data-width='380' data-height='495'>Tweets by DiscusHolland</a>
                    <script async src='//platform.twitter.com/widgets.js' charset='utf-8'></script>
                </div>
                <div class='col-md-4'>
                    <h3 class='footer-title'><b>Contact</b></h3>
                    <br>
                    <p class="footer-contact-text">Heeft u feedback of een vraag? <br> Stuur ons een Bericht!</p>
                    ...
                    <br>
                    <p class="footer-contact-text">Adresstraat: Hoogstraat 73552 XJ Utrecht </p>
                </div>
            </div>
            <br>
