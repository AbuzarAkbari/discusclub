                    ...
                    <table>
                        ...
                        <?php foreach ($results3 as $topic) : ?>
                            ...
                            <tr>
                                ...
                                <?php if (in_array($current_level, $admin_levels)) : ?>
                                <td>
                                    <a  title="Default" href="/includes/tools/topic/default.php?id=<?php echo $topic['id']; ?>&sub_id=<?php echo $subRow['id']; ?>" type="button" class="btn btn-primary " name="button"> <i class="glyphicon glyphicon-file"></i></a>
