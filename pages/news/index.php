...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-110090721-1"></script>
<script>window.dataLayer = window.dataLayer || [];
    ...
    gtag('js', new Date());
    gtag('config', 'UA-110090721-1');</script>
<div id="fb-root"></div>
<script>
    (function (d, s, id) {
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form method="get" action="/news/search">
                            <input type="text" class="form-control" name="q" placeholder='Zoek in het nieuws..'
                                   maxlength="155" required><br>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="/news/" method="post">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="add_topic_title" minlength="3"
                                               maxlength="35" placeholder="Titel (max. 35 tekens)" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <textarea required class="form-control editor" col="8" rows="8"
                                                  name="add_topic_content" style="resize: none;" maxlength="50"
                                                  placeholder="Uw bericht.."></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="submit" class="form-control btn btn-primary" class="form-control"
                                               name="post_add_topic"
                                               value="Toevoegen">
                                    </div>
                                </div>
                    ...
                    <table>
                        ...
                        if (!empty($res)) :
                            foreach ($res as $key => $value) { ?>
                                ...
                                ?>
                                <tr>
                                    <td><a href="/news/post/<?php echo $value->id; ?>"><?php echo $value->title; ?></a>
                                    </td>
                                    <td><?php echo $amount; ?></td>
                                    <td>
                                        <a href="/forum/topic/<?php echo $value->cat_id; ?>"><?php echo $value->sub_name; ?></a>
                                    </td>
                                    <td><?php echo $value->created_at; ?></td>
                                    <?php if ($logged_in && in_array($current_level, $admin_levels)) : ?>
                                        <td>
                                            <a title="Verwijder"
                                               href="/includes/tools/news/del.php?id=<?php echo $value->id; ?>"
                                               type="button" class="btn btn-primary " name="button"><i
                                                        class="glyphicon glyphicon-remove-sign"></i></a>

                                            <!-- Button trigger modal -->
                                            <button type="button" data-id="<?php echo $value->id; ?>"
                                                    class="btn btn-primary change-button"><i
                                                        class=" glyphicon glyphicon-pencil"></i></button>

                                            <!--                                            <a title="Wijzig permissie" href="/includes/tools/news/wijzig.php?id=-->
                                            <?php //echo $value->id; ?><!--" type="button" class="btn btn-primary " name="button"><i class="glyphicon glyphicon-pencil"></i></a>-->
                                        </td>
                                    <?php endif; ?>
                                </tr>
                            <?php } ?>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    as $key => $value) : ?>
                    <a href="/album/post/<?php echo $value['album_id']; ?>" class="blauwtxt">
                        <div class="col-md-12 col-sm-12"><?php echo $value['title'] ?>
                    </a><br><?php echo $value['album_reply_created_at'] ?></div>
                <?php endforeach; ?>
                <?php else : ?>
                    <tr>
                        <td>Geen reacties op albums gevonden</td>
                    </tr>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <a href="/forum/post/<?php echo $value['id']; ?>" class="blauwtxt">
                    <div class="col-md-12 col-sm-12 "><?php echo $value['title'] ?>
                </a><br><?php echo $value['created_at'] ?></div>
            <?php endforeach; ?>
            <?php else : ?>
                <tr>
...
//                        foreach($res as $key => $value) : ?>
<!--                        <a href="/news/post/-->
<?php //echo $value['id']; ?><!--" class="blauwtxt"><div class="col-md-12 col-sm-12 ">-->
<?php //echo $value['title'] ?><!--</a><br>--><?php //echo $value['news_reply_created_at'] ?><!--</div>-->
<!--                        --><?php //endforeach; ?>
<!--                        --><?php //else : ?>
...
<div class="col-md-6">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="col-md-12 col-sm-12 ruimte"><a href="/wordlid"><img alt="Advertentie"
                                                                            src="/images/ad/advertentie.jpg"></div>
            </a>
        </div>
    </div>
</div>
<div class="col-md-6">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            if (!empty($res)) :
                foreach ($res as $key => $value) : ?>
                    <div class=" col-md-4 col-sm-4 ruimte"><a href="/album/post/<?php echo $value["album_id"]; ?>">
                            <div title="image album" class="imgThumbnail"
                                 style="background-image: url('/images<?php echo $value['path'] ?>');"></div>
                        </a><br><?php echo $value['created_at'] ?></div>
                <?php endforeach; ?>
            <?php else : ?>
                <tr>
                    <td>Geen albums gevonden</td>
                </tr>
            <?php endif; ?>
        </div>
    </div>
