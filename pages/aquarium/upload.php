        ...
        <div class="row">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading border-color-blue">
                    <h3 class="panel-title">Aquarium uploaden</h3>
                </div><br>
                <?php if(isset($_GET['error'])): ?>
                    <div class="alert alert-danger" role="alert"><?php echo $_GET['error']; ?></div>
                <?php endif; ?>
                <div class="panel-body ">
                    <form method="post" action="/includes/tools/aquarium-upload" enctype="multipart/form-data">
                        <input type="text" class="form-control" name="aquarium_name" placeholder='Titel' maxlength="32" required ><br>
                        <div class="text-center">
                        <div id="uploader-box" class="box has-advanced-upload" style="cursor: pointer;">
                        ...
                        <button type="submit" name="upload_aquarium" class="box__button btn btn-primary">Upload aquarium</button>
                    </div>
                    </form>
                </div>
            </div>
...
<?php require_once("../../includes/components/footer.php") ; ?>
    ...
    <!-- <script src="/js/aquarium-upload.js"></script> -->
