...
<br>
<a href="<?php echo $url; ?>" target="_blank"><span style="color:#0000FF"><?php echo $url; ?></span></a></span><br>Als deze link niet werk copieer en plak deze link in uw browser:<br>
<?php echo $url; ?>
</span></div>
