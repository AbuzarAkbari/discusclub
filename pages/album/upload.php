            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form method="post" action="/includes/tools/album-upload" enctype="multipart/form-data">
                        <input type="text" class="form-control" name="album_name" placeholder='Titel' required><br>
                        <div class="box has-advanced-upload" onclick="document.getElementById('dinges').click();" style="cursor: pointer;">
                			...
                			<input type="file" name="files[]" id="file" class="box__file" data-multiple-caption="{count} files selected" multiple="" required>
