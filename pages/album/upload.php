            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form method="post" action="/includes/tools/album-upload" enctype="multipart/form-data">
                        <input type="text" class="form-control" name="album-name" placeholder='Titel' required><br>
                        ...
                        <button type="submit" class="box__button btn btn-primary">Upload album</button>
                    </form>
                </div>
            </div>
            <br>
